...
public class DownExcel {
    ...
    public static Map<String, Object> exportRecordTask(HttpServletResponse response, List<String> heardlist,List<DataScore> dataScore) throws Exception {
        ...
        List<DataScore> list = dataScore;//这里是查出来的动态数据，需要跟你的列名对应
        //获取数据长度，获取列长度
